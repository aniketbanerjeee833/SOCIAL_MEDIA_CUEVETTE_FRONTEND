...
const userSlice=createSlice({
    ...
    //     try {
    //       const response = await axios.get("https://social-media-cuevette-1.onrender.com/api/v1/user/allStories",{
    ...
    export const fetchUser = () => async (dispatch) => {
      const token=JSON.parse(localStorage.getItem("APP-TOKEN"))
        ...
        try {
          const response = await axios.get("https://social-media-cuevette-1.onrender.com/api/v1/user/me",
            {
              headers:{
      ...
      export const viewBookmarkStories = () => async (dispatch) => {
        ...
        try {
          const response = await axios.get("https://social-media-cuevette-1.onrender.com/api/v1/user/bookmarkStories", 
              {
                headers:{
            Authorization:`Bearer ${token}`
          }
      ...
      export const getLikesCount = (singleStoryId,slideId) => async (dispatch) => {
        ...
        try {
          const response = await axios.get(`https://social-media-cuevette-1.onrender.com/api/v1/user/likeSlidesCount/${singleStoryId}/${slideId}`,
    ...
    // export const logout = () => async (dispatch) => {
      //   try {
      //     const response = await axios.get("https://social-media-cuevette-1.onrender.com/api/v1/user/logout",{ withCredentials: true });
