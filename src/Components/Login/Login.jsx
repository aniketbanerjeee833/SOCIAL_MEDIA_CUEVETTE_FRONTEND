  ...
  const handleSubmit = async (e) => {
    ...
    if (currState === "login") {
      ...
      try {
        ...
        const response = await axios.post(`https://social-media-cuevette-1.onrender.com/api/v1/user/login`, { userName, password },
      ...
      try {
        const response = await axios.post(`https://social-media-cuevette-1.onrender.com/api/v1/user/register`, { userName, password },
